...
>
  ...
  <div className="flex justify-center gap-8 text-sm text-gray-400">
    <a href = "https://github.com/2004shivanshi/Bad-Talk-Final" className="hover:underline flex items-center gap-2">
      <FaGithub /> View Code
    </a>
    <a href="https://bad-talks.iesipsacademystudentclubs.org/" className="hover:underline">Live Demo</a>
  </div>
</motion.section>
